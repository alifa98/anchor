...
import com.example.psycho.ui.MainViewModel
import com.example.psycho.ui.theme.ListenGreen
import com.example.psycho.ui.theme.ListenGreenDeep
...
@Composable
private fun TranscriptCard(transcript: String, engineState: com.example.psycho.model.EngineState) {
    Card(
        modifier = Modifier.fillMaxWidth(),
        ...
        Column(modifier = Modifier.padding(20.dp)) {
            ...
            val body = when {
                ...
                engineState is com.example.psycho.model.EngineState.Loading ->
                    "Loading the on-device model…"
                engineState is com.example.psycho.model.EngineState.Error ->
