...
import info.faraji.anchor.model.DownloadState
import info.faraji.anchor.model.ModelDownloader
import kotlinx.coroutines.Job
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.collectLatest
import kotlinx.coroutines.launch

// Avoid Downloading while using simulator:
//adb push /locan/on/pc/gemma-4-E2B-it.litertlm /data/local/tmp/
//adb shell "run-as info.faraji.anchor mkdir -p files/models"
//adb shell "run-as info.faraji.anchor cp /data/local/tmp/gemma-4-E2B-it.litertlm files/models/"
